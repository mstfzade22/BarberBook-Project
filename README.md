...
│
├── render.yaml                          # Unified Render deployment config
├── RENDER-UNIFIED-DEPLOYMENT.md         # Deployment guide
...
### Unified Render Deployment (Recommended)

Deploy both frontend and backend as a **single service** on Render for simplicity and cost-effectiveness.
...
The backend Express server serves:

- **API routes** at `/api/*` (backend logic)
- **Static files** at `/` (frontend HTML/CSS/JS)

This unified approach:

- ✅ Eliminates CORS issues
- ✅ Reduces costs (one service instead of two)
- ✅ Simplifies deployment
- ✅ Provides single URL for entire app

**Detailed Guide:** See [`RENDER-UNIFIED-DEPLOYMENT.md`](RENDER-UNIFIED-DEPLOYMENT.md)
...
**Docker Guide:** See [`BarberBook-Backend/DOCKER-DEPLOY.md`](BarberBook-Backend/DOCKER-DEPLOY.md)
